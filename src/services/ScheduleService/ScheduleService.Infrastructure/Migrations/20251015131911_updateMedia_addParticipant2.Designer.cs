...
namespace ScheduleService.Infrastructure.Migrations
{
    ...
    [Migration("20251015131911_updateMedia_addParticipant2")]
    partial class updateMedia_addParticipant2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScheduleService.Domain.Entities.ActivityAttendance", b =>
                {
                    b.HasOne("ScheduleService.Domain.Entities.ScheduleActivity", "Activity")
                        .WithMany("ActivityAttendances")
                        .HasForeignKey("ActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ScheduleService.Domain.Entities.ScheduleParticipant", "Participant")
                        .WithMany("ActivityAttendances")
            ...
            modelBuilder.Entity("ScheduleService.Domain.Entities.ScheduleActivity", b =>
                {
                    b.Navigation("ActivityAttendances");
