...
using AdvertisementService.Infrastructure.Extensions;
using DotNetEnv;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "AdvertisementService API",
        Version = "v1", // Version của API
        Description = "API for Advertisement Management",
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "AdvertisementService API V1");
});
